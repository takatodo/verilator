...
test.file_grep(bench_memory_image_log, r"memory_image_payload_visible_entries=4")
test.file_grep(bench_memory_image_log, r"memory_image_payload_hidden_entries=0")
...
test.file_grep(bench_memory_image_log, r"array_preload_hidden_rows_loaded=0")
test.file_grep(bench_memory_image_log, r"array_preload_hidden_only_targets=0")
