...
test.file_grep(bench_run_log, r"cuda_assignw_coverage_scope=post_lowering_assignw_nodes")
test.file_grep(bench_run_log, r"cuda_assignw_coverage_basis=supported_assignw_div_total_assignw")
