...
seed1_log = batch_dir + "/scenarios/seed000001/driver_stdout.log"
seed2_log = batch_dir + "/scenarios/seed000002/driver_stdout.log"
...
for filename in [summary_json, summary_tsv, seed1_log, seed2_log]:
...
test.file_grep(summary_tsv, r"seed000001")
test.file_grep(summary_tsv, r"seed000002")
