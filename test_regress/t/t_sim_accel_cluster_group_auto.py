...
cache_dir = test.obj_dir + "/sim_accel_cluster_group_auto_cache"
bench_dir = test.obj_dir + "/sim_accel_cluster_group_auto_bench"
...
bench_cmd = (
    ...
    + " --hybrid-cluster-group-size 2"
    + " --hybrid-cluster-group-auto-max-input-bits 256"
...
test.file_grep(bench_log, r"hybrid_cluster_group_auto=1")
test.file_grep(bench_log, r"hybrid_cluster_group_auto_group_size=2")
test.file_grep(bench_log, r"hybrid_cluster_group_auto_max_input_bits=256")
test.file_grep(bench_log, r"hybrid_cluster_group_auto_candidate_count=[1-9][0-9]*")
